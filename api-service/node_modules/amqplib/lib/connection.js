...
const Mux = require('amqplib/lib/mux').Mux;

const Duplex = require('node:stream').Duplex;
const EventEmitter = require('node:events');
const Heart = require('amqplib/lib/heartbeat').Heart;

const methodName = require('amqplib/lib/format').methodName;
const closeMsg = require('amqplib/lib/format').closeMessage;
const inspect = require('amqplib/lib/format').inspect;

const BitSet = require('amqplib/lib/bitset').BitSet;
const fmt = require('node:util').format;
const PassThrough = require('node:stream').PassThrough;
const IllegalOperationError = require('amqplib/lib/error').IllegalOperationError;
const stackCapture = require('amqplib/lib/error').stackCapture;
