...
const HEARTBEAT = require('amqplib/lib/frame').HEARTBEAT;
const HB_BUF = require('amqplib/lib/frame').HEARTBEAT_BUF;
const OPEN_OPTS = require('amqplib/test/lib/data').OPEN_OPTS;
const heartbeat = require('amqplib/lib/heartbeat');
const { latch, handshake, runServer, socketPair } = require('amqplib/test/lib/util');
...
describe('Connection', () => {
  ...
  describe('Connection errors', () => {
    ...
    it('bad frame during open', (_t, done) => {
      const ss = socketPair();
      const conn = new (require('amqplib/lib/connection').Connection)(ss.client);
