...
const connect = require('amqplib/lib/connect').connect;
const defs = require('amqplib/lib/defs');
const { plain, amqplain } = require('amqplib/lib/credentials')
const { latch, runServer } = require('amqplib/test/lib/util');
